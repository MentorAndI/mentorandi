...
- `/contact` links to `support@mentorandi.com`, directs authenticated users to
  the Feedback button in `/start` or `/mentor`, and lists the details to include
...
The contact page intentionally uses email and authenticated in-product feedback
rather than a public contact form during alpha.
