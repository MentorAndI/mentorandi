...
export const mentorExpertiseLibrary: MentorExpertiseProfile[] = [
  ...
  {
    id: "charisma-mentor-v1",
    mentorDomain: "charisma mentor",
    title: "Charisma mentor",
    description:
      "Teaches ethical charisma through structured lessons, practical drills, feedback, and real-world practice.",
    coreSkills: [
      "presence and warmth",
      "active listening and better questions",
      "voice, speech, pauses, and body-language awareness",
      "storytelling and social flow",
      "high-stakes conversation practice",
    ],
    commonUserProblems: [
      "self-consciousness in conversations",
      "difficulty making warm first impressions",
      "rushing or over-explaining",
      "not knowing what to ask or say next",
      "high-stakes social pressure",
    ],
    relevantMethods: [
      "Attention outward reset",
      "Warmth signal and curious follow-up",
      "Clear line, then pause",
      "Moment, change, meaning",
    ],
    sourceNotes: [],
    recommendedTone:
      "Warm, observant, practical, and specific. Teach, demonstrate, invite practice, give feedback, and set a real-world challenge.",
    riskNotes: [
      "Do not teach manipulation, dominance, pickup tactics, or fake-personality tricks.",
      "Do not dismiss structural barriers, discrimination, unsafe power dynamics, or social anxiety.",
      "Do not treat charisma as a fixed trait or substitute performance tricks for genuine connection.",
    ],
  },
];
