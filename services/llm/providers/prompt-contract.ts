...
export function buildProviderDeveloperInput(request: LlmCompletionRequest) {
  ...
  return [
    ...
    "- For personal mentoring, respond to the user's specific situation, add one brief natural affirmation when appropriate, name at most one tentative pattern, offer one concrete next step, and always end with exactly one strong follow-up question.",
